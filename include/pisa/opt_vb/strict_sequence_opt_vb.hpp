...
#include "./strict_elias_fano_opt_vb.hpp"
...
namespace pvb {
    ...
    struct strict_sequence_opt_vb {
        ...
        static global_parameters_opt_vb strict_params(global_parameters_opt_vb params)
        {
        ...
        {
            (void)begin;
            uint64_t best_cost = all_ones_sequence_opt_vb::bitsize(params, universe, n);
            auto sparams = strict_params(params);

            uint64_t ef_cost = strict_elias_fano_opt_vb::bitsize(sparams, universe, n) + type_bits;
                          ...
                          global_parameters_opt_vb const& params)
        {
            ...
            switch (best_type) {
            case elias_fano:
                strict_elias_fano_opt_vb::write(bvb, begin,
                                         universe, n,
                                         sparams);
                break;
            case ranked_bitvector:
                ...
                break;
            case all_ones:
                all_ones_sequence_opt_vb::write(bvb, begin,
                                         universe, n,
                                         sparams);
                break;
            default:
        ...
        public:
                       ...
                       global_parameters_opt_vb const& params)
            {
                ...
                if (all_ones_sequence_opt_vb::bitsize(params, universe, n) == 0) {
                    m_type = all_ones;
                } else {
                ...
                switch (m_type) {
                case elias_fano:
                    m_ef_enumerator = strict_elias_fano_opt_vb::enumerator(bv, offset + type_bits,
                                                                    universe, n,
                                                                    sparams);
                    break;
                case ranked_bitvector:
                    ...
                    break;
                case all_ones:
                    m_ao_enumerator = all_ones_sequence_opt_vb::enumerator(bv, offset + type_bits,
                                                                    universe, n,
                                                                    sparams);
                    break;
                default:
