...
namespace pvb {
    ...
    struct strict_elias_fano_opt_vb {
                          ...
                          global_parameters_opt_vb const& params)
        {
            ...
            compact_elias_fano_opt_vb::write(bvb, new_begin, new_universe, n, params);
        }
        ...
        private:
            compact_elias_fano_opt_vb::enumerator m_ef_enum;
        };
